...
import MoviesOf from "@/pages/filmes-de/MoviesOf";
...
describe("MoviesOf", () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    vi.mocked(useAuth).mockReturnValue({ user: { id: "user1", pair: { id: "user2" } } } as any);
  ...
  it("should render loading state", async () => {
    ...
    render(<MemoryRouter><MoviesOf /></MemoryRouter>);
